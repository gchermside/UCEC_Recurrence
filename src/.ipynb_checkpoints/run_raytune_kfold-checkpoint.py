...
Usage: python run_raytune_kfold.py <feature_selection_method>
...
from model_utils import GeneSelector, ModalityEncoder, set_random_seed, build_optimizer
...
def main():
    parser = argparse.ArgumentParser(description='Run Ray Tune hyperparameter search with k-fold CV and feature selection')
    ...
    print(f"\n{'='*80}")
    print(f"Best trial results (averaged across {n_folds} folds):")
    ...
    print(f"Best F1 (avg across folds): {best_trial.last_result['f1']:.4f}")
